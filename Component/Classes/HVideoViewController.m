...
- (void)viewDidLoad {
    ...
    self.backCenterX.constant = -(HScreenWidth/2/2)-image.size.width/2/2;
...
- (void)changeLayout {
    ...
    self.afreshCenterX.constant = -(HScreenWidth/2/2);
    self.ensureCenterX.constant = HScreenWidth/2/2;
